...
export const LoginScreen: React.FC = () => {
  ...
  const handleDemoLogin = async () => {
    ...
    try {
      ...
      setError('Não foi possível entrar com a conta rápida. Você pode criar sua própria conta na aba "Criar Conta".');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md px-4 z-10">
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-emerald-600 shadow-xl shadow-emerald-900/30 text-white mx-auto mb-2 border border-emerald-400/30">
          ...
          <p className="text-xs font-semibold text-emerald-400 uppercase tracking-wider">
            CRM de Correspondente Bancário & Financiamento Imobiliário
          </p>
        </div>
        ...
        <div className="mt-8 bg-slate-900/90 backdrop-blur-md py-8 px-5 sm:px-10 shadow-2xl rounded-3xl border border-slate-800">
          ...
          {/* Quick 1-Click Access for Instant Exploration */}
          <div className="mt-6 pt-5 border-t border-slate-800/80">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full py-2.5 px-3 rounded-xl bg-slate-800/80 hover:bg-slate-800 text-slate-200 text-xs font-bold border border-slate-700 transition flex items-center justify-center gap-2 cursor-pointer"
            >
              <Sparkles className="w-3.5 h-3.5 text-amber-400" />
              <span>Entrar como Administrador Morada Crédito</span>
            </button>

            <div className="mt-3 p-2.5 rounded-lg bg-slate-950/60 border border-slate-800/60 text-[11px] text-slate-400 space-y-1">
              <div className="flex items-center justify-between">
                <span>E-mail:</span>
                <span className="text-slate-200 font-mono">contato@moradacredito.com.br</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Senha padrão:</span>
                <span className="text-slate-200 font-mono">Morada@2026</span>
              </div>
            </div>
          </div>
        </div>
